...
public class SplashActivity extends Activity {
    ...
    TextView tvVersion, tvSubLogo, tvLogo;
    ImageView ivLogo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvVersion.setTypeface(Typeface.createFromAsset(getAssets(), "fonts/kaushan-script.regular.ttf"));
        tvLogo = (TextView) findViewById(R.id.tvLogo);
        tvLogo.setTypeface(Typeface.createFromAsset(getAssets(), "fonts/kaushan-script.regular.ttf"));
        tvSubLogo = (TextView) findViewById(R.id.tvSubLogo);
        tvSubLogo.setTypeface(Typeface.createFromAsset(getAssets(), "fonts/kaushan-script.regular.ttf"));
        ...
        animLoad.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationStart(Animation animation) {
                if (isConnected()) {
                    ...
                    CustomActivityOnCrash.setDefaultErrorActivityDrawable(R.drawable.ic_crash);
