...
public class CompactCalendarTab extends Fragment implements Response.Listener<String> {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        actionBar.setTitle(dateFormatForMonth.format(new Date()));
...
//        });
    ...
    private void addEvents(CompactCalendarView compactCalendarView, String message) {
        ...
        List<Event> events = getEvents(timeInMillis, timeFormat.format(c.getTime()), message);

        compactCalendarView.addEvents(events);
    }

    private List<Event> getEvents(long timeInMillis, String time, String message) {
        return Arrays.asList(new Event(R.color.calender_event_node, timeInMillis, message + "\n" + getString(R.string.eventActivity_time) + " " + time));
    }
